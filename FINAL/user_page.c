...
int i=0;
    ...
    while(1){
        ...
        f_string_format(1, "\033[1m ==============\033[0m\n");
         f_string_format(0, yellow" City List\n"end);
        f_string_format(0, yellow" 1. Mumbai\n"end);
        f_string_format(0, yellow" 2. Delhi\n"end);
        f_string_format(0, yellow" 3. Bangalore\n"end);
        f_string_format(0, yellow" 4. Kolkata\n"end);
        f_string_format(0, yellow" 5. Chennai\n"end);
        f_string_format(0, yellow" 6. Udaipur\n"end);
        f_string_format(0, yellow" 7. Ahmedabad\n"end);
        f_string_format(0, yellow" 8. Goa\n"end);
        f_string_format(0, yellow" 9. Manali\n"end);
        f_string_format(0, yellow" 10. Hyderabad\n"end);
        f_string_format(0, yellow" 11. Exit\n"end);
        f_string_format(1, " ==============================\n");
